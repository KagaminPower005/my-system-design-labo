...
import domain.car_table02.car_table_row;
import domain.car_table02.id;
import domain.car_table02.name;
    ...
    public CarDBBean02()
    {
        try{
            ...
            while(rs.next()){
                ...
                name myName = name.valueOf(rs.getString(name.class.getSimpleName()));
