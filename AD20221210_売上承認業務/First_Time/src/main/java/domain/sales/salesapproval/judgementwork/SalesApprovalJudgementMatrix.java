...
public class SalesApprovalJudgementMatrix {
    ...
    final Map<String, SalesApproval> make() {
        ...
        JudgementMatrix.put("OK△OK△OK△--△--△--△--△OK", SalesApproval.OK); //与信枠ランクSのチェック
        JudgementMatrix.put("OK△OK△--△OK△--△--△--△OK", SalesApproval.OK); //与信枠ランクAのチェック
        JudgementMatrix.put("OK△OK△--△--△OK△--△--△OK", SalesApproval.OK); //与信枠ランクBのチェック
