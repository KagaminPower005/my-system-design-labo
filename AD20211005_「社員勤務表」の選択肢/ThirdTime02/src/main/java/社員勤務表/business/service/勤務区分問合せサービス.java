...
public class 勤務区分問合せサービス {
    ...
    private List<勤務区分> my勤務区分list = new ArrayList<勤務区分>();
    ...
    private List<勤務区分> テレワーク設定(){
        my勤務区分list.add(勤務区分.フル出勤);
        my勤務区分list.add(勤務区分.午前休);
        my勤務区分list.add(勤務区分.午後休);

        return  Collections.unmodifiableList(my勤務区分list);
    }
    private List<勤務区分> 出社設定(){
        my勤務区分list.add(勤務区分.フル出勤);
        my勤務区分list.add(勤務区分.午前休);
        my勤務区分list.add(勤務区分.午後休);
    ...
    private List<勤務区分> 非出社設定(){
        my勤務区分list.add(勤務区分.週休日);
        my勤務区分list.add(勤務区分.休暇);
        my勤務区分list.add(勤務区分.欠勤);
